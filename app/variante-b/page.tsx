    ...
    <main style={{ color: g.deep, overflowX: "hidden" }}>
      ...
      <section style={{ paddingTop: 71, minHeight: "100vh", display: "grid", gridTemplateColumns: "1fr 1fr" }}>
        ...
        <div style={{ background: g.deep, display: "flex", flexDirection: "column", justifyContent: "center", padding: "80px 64px", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, display: "grid", gridTemplateColumns: "repeat(3, 1fr)", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
            {[
              ...
              <div key={i} className={`reveal reveal-d${i + 1}`} style={{ padding: "20px 24px", borderRight: i < 2 ? "1px solid rgba(255,255,255,0.08)" : "none" }}>
        ...
        <div style={{ position: "relative", overflow: "hidden" }}>
          ...
          />
          <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to right, rgba(0,0,0,0.12) 0%, transparent 60%)" }} />
        ...
        <div style={{ maxWidth: 1400, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 2 }}>
            {rooms.slice(0, 3).map((room, i) => (
              <div key={i} className={`reveal-scale reveal-d${i + 1}`} style={{ position: "relative", height: 380, overflow: "hidden" }}>
                <img src={room.img} alt={room.name} loading="lazy" className="img-zoom" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
                <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(0,0,0,0.78) 0%, rgba(0,0,0,0.12) 55%, transparent 100%)" }} />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 2, marginTop: 2 }}>
            {rooms.slice(3).map((room, i) => (
              <div key={i} className={`reveal-scale reveal-d${i + 1}`} style={{ position: "relative", height: 300, overflow: "hidden" }}>
                <img src={room.img} alt={room.name} loading="lazy" className="img-zoom" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
                <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(0,0,0,0.78) 0%, rgba(0,0,0,0.08) 50%, transparent 100%)" }} />
        ...
        <div style={{ maxWidth: 1400, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
            {[
              ...
              <div key={i} className={`reveal reveal-d${i + 1}`} style={{ border: `2px solid ${t.featured ? g.gold : g.sand}`, padding: "36px 32px", position: "relative", background: t.featured ? "rgba(212,169,112,0.08)" : "white" }}>
      ...
      <section id="servicios" style={{ background: g.deep }}>
        {[
          ...
          <div key={i} className={i === 0 ? "reveal-slide-right" : "reveal-slide-left"} style={{ display: "grid", gridTemplateColumns: "1fr 1fr", borderTop: i > 0 ? "1px solid rgba(255,255,255,0.06)" : "none" }}>
            {s.reverse ? (
              <>
                <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", padding: "72px 64px" }}>
                  <div className="reveal-draw" style={{ width: 40, height: 2, background: g.gold, marginBottom: 28 }} />
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
          {[
            ...
            <div key={i} className={`reveal reveal-d${i + 1}`} style={{ padding: "36px 32px", borderRight: i < 3 ? "1px solid rgba(255,255,255,0.06)" : "none" }}>
      ...
      <section id="galería" style={{ background: g.sand }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gridTemplateRows: "240px 240px" }}>
          {[
            ...
            <div key={i} className={`reveal-scale reveal-d${i + 1}`} style={{ overflow: "hidden" }}>
      ...
      <section className="reveal" style={{ background: g.sand, padding: "96px 40px" }}>
        <div style={{ maxWidth: 1400, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
          <div>
            <span className="reveal reveal-d1" style={{ fontFamily: g.fontM, fontSize: 9, letterSpacing: "0.3em", textTransform: "uppercase", color: g.deep, opacity: 0.7, display: "block", marginBottom: 16 }}>Mejor precio garantizado</span>
            <h2 className="reveal reveal-d2" style={{ fontFamily: g.fontG, fontSize: "clamp(48px, 6.5vw, 88px)", color: g.deep, margin: "0 0 20px 0", lineHeight: 0.88, letterSpacing: "-0.02em" }}>
          ...
          <div className="reveal reveal-d4" style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      {/* ── CONTACTO ── */}
      <section id="contacto" className="reveal" style={{ background: g.ivory, padding: "80px 40px" }}>
