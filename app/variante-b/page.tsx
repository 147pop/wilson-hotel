    ...
    <main style={{ color: g.deep, overflowX: "hidden" }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 40px", height: 68, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", gap: 12 }}>
            <a href="tel:+543874312211" style={{ fontFamily: g.fontM, fontSize: 10, color: g.graphite, textDecoration: "none", opacity: 0.55, letterSpacing: "0.05em" }}>(387) 4-312211</a>
          ...
          <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, display: "grid", gridTemplateColumns: "repeat(3, 1fr)", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
            {[
              ...
              <div key={i} style={{ padding: "20px 24px", borderRight: i < 2 ? "1px solid rgba(255,255,255,0.08)" : "none" }}>
                ...
                <div style={{ fontFamily: g.fontM, fontSize: 9, letterSpacing: "0.15em", textTransform: "uppercase", color: g.sand, opacity: 0.55, marginTop: 4 }}>{s.label}</div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
            {[
              ...
              <div key={i} style={{ border: `2px solid ${t.featured ? g.gold : g.sand}`, padding: "36px 32px", position: "relative", background: t.featured ? "rgba(212,169,112,0.08)" : "white" }}>
                ...
                <p style={{ fontFamily: g.fontM, fontSize: 12, color: g.graphite, lineHeight: 1.7, margin: 0, opacity: 0.75 }}>{t.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
          {[
            ...
            <div key={i} style={{ padding: "36px 32px", borderRight: i < 3 ? "1px solid rgba(255,255,255,0.06)" : "none" }}>
              ...
              <p style={{ fontFamily: g.fontM, fontSize: 11, color: g.sand, margin: 0, opacity: 0.6, lineHeight: 1.5 }}>{s.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="galería" style={{ background: g.sand }}>
        ...
        <div style={{ background: g.deep, padding: "20px 40px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <span style={{ fontFamily: g.fontM, fontSize: 9, letterSpacing: "0.2em", textTransform: "uppercase", color: g.sand, opacity: 0.5 }}>Galería de imágenes</span>
      ...
      <section style={{ background: g.sand, padding: "96px 40px" }}>
        <div style={{ maxWidth: 1400, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
          <div>
            <span style={{ fontFamily: g.fontM, fontSize: 9, letterSpacing: "0.3em", textTransform: "uppercase", color: g.blue, opacity: 0.6, display: "block", marginBottom: 16 }}>Mejor precio garantizado</span>
            ...
            <p style={{ fontFamily: g.fontM, fontSize: 13, color: g.graphite, lineHeight: 1.7, margin: 0, opacity: 0.75 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <a href="https://wa.me/543874312211" target="_blank" rel="noopener noreferrer"
              style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, fontFamily: g.fontM, fontSize: 11, letterSpacing: "0.15em", textTransform: "uppercase", color: g.deep, textDecoration: "none", border: `1px solid rgba(11,44,87,0.3)`, padding: "16px 40px", opacity: 0.7, transition: "opacity 0.2s" }}>
            ...
            <a href="tel:+543874312211" style={{ fontFamily: g.fontM, fontSize: 11, color: g.deep, textDecoration: "none", textAlign: "center", opacity: 0.45, letterSpacing: "0.05em" }}>
              (+54 387) 4-312211
            </a>
          </div>
        </div>
      ...
      <footer style={{ background: g.deep }}>
        ...
        <div style={{ maxWidth: 1400, margin: "0 auto", padding: "36px 40px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <p style={{ fontFamily: g.fontM, fontSize: 10, color: g.sand, opacity: 0.35 }}>© {new Date().getFullYear()} Wilson Hotel S.A.</p>
          <p style={{ fontFamily: g.fontM, fontSize: 10, color: g.sand, opacity: 0.35 }}>IVA 21% incluido · reservas@wilsonhotel.com.ar</p>
        </div>
      </footer>
    </main>
  );
