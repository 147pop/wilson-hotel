...
const rooms: { key: RoomKey; name: string; occ: string; img: string; desc: string }[] = [
  ...
  { key: "MAT", name: "Habitación Doble Matrimonial Estándar", occ: "1–2 personas", img: "/hotel/habitaciones/doble-standard/doble-standard-01.webp", desc: "Ambiente acogedor para parejas. Cama queen, TV LED y refrigerador." },
