...
const rooms: { key: RoomKey; name: string; occ: string; img: string; desc: string }[] = [
  ...
  { key: "JRS", name: "Habitación Doble Matrimonial Junior", occ: "1–2 + extra", img: "/hotel/habitaciones/doble-suite-sillones/doble-suite-sillones-05.webp", desc: "La más amplia del hotel. Mayor espacio, decoración refinada y vista mejorada." },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-0.5">
          ...
          >
            {[
              ...
              {
                name: "Recepción 24 hs", desc: "Atención y asistencia permanente",
